...
if __name__ == '__main__':
    ...
    std_pm_per_station = da_calibrated.stack(station_pm=('station', 'variable')).groupby('station_pm').std('time')
    ...
    da_toplot = era5.sel(time='2021-08-03T23:00:00') \
         .coarsen(latitude=3, longitude=3, boundary='trim').mean()\
         .sortby('latitude')

    ax = plt.subplot(projection=ccrs.Orthographic(-0.560294, 51.315831))
    p = da_toplot.plot.quiver(
        x='longitude', y='latitude',
        u='u10', v='v10',
        subplot_kws=dict(projection=ccrs.Orthographic(-0.560294, 51.315831),
                         facecolor="gray"),
